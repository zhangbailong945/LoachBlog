...
// Establish our default settings
        ...
        this.each(function() {
            ...
            function create() {
                ...
                var content;
                var snowpath="http://localhost/LoachBlog/communal/Administrator/images/snowflake/snowflake";
                // alert(imageSize);
                ...
                for (var i = 1; i <= 25; i++) {
                    if (settings.snowflaketype === i) {
                        if (i === 21) {
                            content = '<img class="flakeimage" style="height:' + imageSize + 'px; width:' + imageSize + 'px;"src="'+snowpath+''+ number1 + '.png"/>'
                        } else if (i === 22) {
                            content = '<img class="flakeimage" style="height:' + imageSize + 'px; width:' + imageSize + 'px;"src="'+snowpath+'' + number2 + '.png"/>'
                        } else if (i === 23) {
                            content = '<img class="flakeimage" style="height:' + imageSize + 'px; width:' + imageSize + 'px;"src="'+snowpath+'' + number3 + '.png"/>'
                        } else if (i === 24) {
                            content = '<img class="flakeimage" style="height:' + imageSize + 'px; width:' + imageSize + 'px;"src="'+snowpath+'' + number4 + '.png"/>'
                        } else if (i === 25) {
                            content = '<img class="flakeimage" style="height:' + imageSize + 'px; width:' + imageSize + 'px;"src="'+snowpath+'' + number5 + '.png"/>'
                        } else {
                            content = '<img class="flakeimage" style="height:' + imageSize + 'px; width:' + imageSize + 'px;"src="'+snowpath+'' + i + '.png"/>'
                        }
